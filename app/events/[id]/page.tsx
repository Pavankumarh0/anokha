...
const eventPosters: Record<string, { title: string; desc: string; poster: string }> = {
  ...
  "EVT-07": { title: "KALPANA – App Prototype", desc: "Design the next big app", poster: "/event_posters/kalpana.png" },
  "EVT-08": { title: "Chain of Minds", desc: "Collaborative problem solving", poster: "/event_posters/chain of minds.jpeg" },
  ...
  "NTE-10": { title: "Hasya-Krida", desc: "Roast the crowd", poster: "/event_posters/hasya-krida.png" },
