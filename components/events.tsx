...
const technicalEvents = [
  ...
  { id: "EVT-07", title: "KALPANA – App Prototype", icon: "📱", desc: "Design the next big app", type: "technical" as const, poster: "/event_posters/kalpana1.png" },
  { id: "EVT-08", title: "Chain of Minds", icon: "🔗", desc: "Collaborative problem solving", type: "technical" as const, poster: "/event_posters/chain of minds1.jpeg" },
